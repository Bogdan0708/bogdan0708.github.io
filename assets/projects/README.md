...
EuFund is a diagram of the public exhibit workflow. MitchAI is a visual summary of saved synthetic execution responses from 13 September 2026, with model endpoints and the database sink substituted. These two graphics are not application screenshots or new execution evidence. PrimărIA is an unmodified existing repository screenshot of the export interface, with an empty history. It is historical UI evidence, not certification or a live municipal service.

## 14 September clarity update
